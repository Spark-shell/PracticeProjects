...
//2014-03-05
date_util.getYear = function (s_date) {
    return s_date.substring(0, 4);
};
date_util.getMonth = function (s_date) {
    return s_date.substring(5, 7);
};
date_util.getDay = function (s_date) {
    return s_date.substring(8);
};
