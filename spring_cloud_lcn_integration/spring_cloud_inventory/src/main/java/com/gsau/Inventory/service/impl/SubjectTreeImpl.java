...
import com.gsau.Inventory.mapper.SubjectTreeMapper;
import com.gsau.Inventory.util.GsonUtil;
import com.gsau.Inventory.util.SystemConfig;
import com.gsau.inventory_sersvice.projo.po.Subject;
...
public class SubjectTreeImpl {
    @Autowired
    private SubjectTreeMapper subjectMapper;
    ...
    public void init() {
        ...
        all_list = (List<Subject>) subjectMapper.findAll();
