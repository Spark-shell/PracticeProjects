...
import com.gsau.factory.AnnocationBeanFactory;
...
public class ApplicationTest {
     public static void main(String[] args) {
          ...
          AccountServiceImpl accountService= AnnocationBeanFactory.getBean("accountServiceImpl",AccountServiceImpl.class);
